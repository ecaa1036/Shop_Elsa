...
<body>
    <nav class="navbar navbar-expand-lg bg-secondary text-white fixed-top" id="mainNav text-white">
        <div class="container">
            <a class="navbar-brand" href="#page-top">ELSA NOVIANTI</a>
            {{-- <a class="navbar-brand" href="#page-top">ELSA NOVIANTI :{{Auth()->user()->"name"}}</a> --}}
            <button class="navbar-toggler text-white font-weight-bold bg-secondary text-white rounded" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto text-white">
                    ...
                    <li class="nav-item mx-0 mx-lg-1">
                        <a href="hmproduk" class="nav-link {{ Request::segment(1)=='hmproduk'?'active':'' }}">Product</a></li>
                    {{-- <li class="nav-item mx-0 mx-lg-1">
